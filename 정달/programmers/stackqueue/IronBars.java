...
public class IronBars {
    public int solution(String ar) {
        ...
        for(int i = 0; i < length ; i ++) {
            String test = "";
            if(i<length-1){
                test = ar.substring(i, i+2);
            }else{
                test = ar.substring(i, i+1);
            }
            if(test.equals(laser)){
                i= i+1;
                totalBars = totalBars + barsOnRail;
            }else{
        ...
        int answer = totalBars;
        return answer;
    }

    public static void main(String[] args) {
        System.out.println(new IronBars().solution("()(((()())(())()))(())"));
    }
}
