...
public class BinaryTree5639 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(new BinaryTree5639().solution(sb, list).toString());
    ...
    private StringBuffer solution(StringBuffer sb, List<String> nodeInfo) {
        ...
        for(int i = 1 ; i <= length ; i ++ ) {
            int data = Integer.parseInt(nodeInfo.get(i-1));
            now = new Node(data, null, null, null , true);
            if(i==1){
                root = now;
                before = now;
                continue;
            ...
            if( now.data < before.data ) {
                ...
                while(true){
                    if( before.parent!=null ) {
                        if( before.parent.isLeft && now.data > before.parent.data ){
